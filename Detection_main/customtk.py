...
label.place(relx=0.5,rely =0.13,anchor="n")
...
btn_text_to_speech = CTkButton(master=app, text="Text to Speech", command=click_handler,height=100,width=600)
btn_text_to_speech.place(relx=0.5, rely=0.3, anchor="center")

btn_function1 = CTkButton(master=app, text="Speech To Text", command=click_handler_function1,height=100,width=600)
btn_function1.place(relx=0.5, rely=0.5, anchor="center")

btn_function2 = CTkButton(master=app, text="Hand Sign Detection", command=click_handler_function2,height=100,width=600)
btn_function2.place(relx=0.5, rely=0.7, anchor="center")

btn_function3 = CTkButton(master=app, text="Object Detection", command=click_handler_function3,height=100,width=600)
btn_function3.place(relx=0.5, rely=0.9, anchor="center")
